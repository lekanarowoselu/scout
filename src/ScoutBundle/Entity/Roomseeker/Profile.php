...
namespace Octopouce\CareerBundle\Entity\Jobseeker;
 ...
 * Jobseeker
 *
 * @ORM\Table(name="jobseeker_profile")
 * @ORM\Entity(repositoryClass="Octopouce\CareerBundle\Repository\Jobseeker\ProfileRepository")
 *
